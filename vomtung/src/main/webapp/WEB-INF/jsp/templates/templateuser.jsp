    ...
    <body>
        ...
        <div id="wrap">
            ...
            <div class="header">
                ...
                <div id="menu">
                    <ul>                                                                       
                        <li ${page == 'home' ? 'class="selected"' : ''}><a href="${pageContext.servletContext.contextPath}/template.html">home</a></li>
                        ...
                        <li ${page == 'myaccount' ? 'class="selected"' : ''}><a href="${pageContext.servletContext.contextPath}/template/myaccount.html">my accout</a></li>
